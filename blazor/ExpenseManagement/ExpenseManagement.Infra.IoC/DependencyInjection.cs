...
using ExpenseManagement.Application.Mappings;
...
using ExpenseManagement.Infra.Data.Repositories;
...
namespace ExpenseManagement.Infra.IoC
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            var myHandlers = AppDomain.CurrentDomain.Load("ExpenseManagement.Application");
